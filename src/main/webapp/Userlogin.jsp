...
<style>
body {
	background: url("img/Userlogin/user.jpg") no-repeat center center/cover;
	min-height: 100vh;
}
		...
		<div
			...
			<div class="text-center mb-4">
				...
				<p class="text-sm mt-1">
					Don’t Have An Account? <a href="UserReg.jsp"
						class="text-green-400 font-semibold">Register Now</a>
				</p>
			</div>

			<form action="UserLogin" method="post">
				<div class="mb-3">
					<label class="form-label text-sm">Username *</label> <input
				...
				<div class="flex space-x-4">
					<a href="Adminlogin.jsp" class="text-yellow-500 font-semibold">Admin Login</a> 
						<a href="Stafflogin.jsp" class="text-green-500 font-semibold">Staff Login</a>
				</div>
